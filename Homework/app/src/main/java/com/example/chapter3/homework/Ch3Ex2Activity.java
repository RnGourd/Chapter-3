...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animatorX = ObjectAnimator.ofFloat(target, "scaleX", 1.0f, 2.0f);
        ObjectAnimator animatorY = ObjectAnimator.ofFloat(target, "scaleY", 1.0f, 2.0f);
        ...
        ObjectAnimator animatorTransparency = ObjectAnimator.ofFloat(target, "Alpha", 1.0f, 0.5f);
        animatorTransparency.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animatorTransparency.setRepeatCount(ObjectAnimator.INFINITE);
        animatorTransparency.setRepeatMode(ObjectAnimator.REVERSE);
        ...
        animatorSet.playTogether((animatorTransparency));
        animatorSet.start();
    }
}
